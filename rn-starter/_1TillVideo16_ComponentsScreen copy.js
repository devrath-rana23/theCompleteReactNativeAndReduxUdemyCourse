...
//This component will return a JSX which looks a lot like a HTML which tells react-native what to show on screen.
// const ComponentsScreen=function () { This is keyword function syntax

const ComponentsScreen = () => {

  /*
  Now we can use this Js variable inside JSX using {} curly braces
  Exception=> If we assign an object to this variable will give error
  Example : const greeting={color:'red'}
  */

  // const greeting = {color:'red'};gives error

  const greeting = 'BYE-BYE!'
  const greeting_jsx_element = <Text>Hey Man!</Text>;//we can display this jsx element after applying some conditions below.
  const greeting_array = [123, 'Bye!'];

  // PROPS When we create JSX elements, we can specify some configure options and we refer to them as props.

  /*
  Syntax for multi line JSX element is =>return (
JSX elements
  );
  ...
  */
  ...
  return (
    <View>
      ...
      <Text>{greeting}</Text>
      <Text>{greeting_array}</Text>
      {greeting_jsx_element}
    </View>
  );
};
...
/*#__PURE__*/
  ...
  const styles = StyleSheet.create({
    ...
    // We can think of this as creating a grouping of different styling rules that we're going to apply to a name called text style.
