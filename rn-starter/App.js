...
const navigator = createStackNavigator(
  ...
  {
    initialRouteName: "List",//This is description or configuration option that tells this navigator thing what the first component is that should be displayed right now.Here it is set as Home so it will search the Home option from above options or stack and display that component screen first.
